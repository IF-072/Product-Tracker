...
$form.find('.subscribe').on('click', payClicked);

function payClicked(e) {
    e.preventDefault();
    /* Visual feedback */
    $form.find('.subscribe').html(validating + ' <i class="fa fa-spinner fa-pulse"></i>').prop('disabled', true);
    setTimeout(function(){$form.find('.subscribe').html(paymentSuccessful + ' <i class="fa fa-check"></i>'); window.location.href='/profile/getPremium';}, 500);
