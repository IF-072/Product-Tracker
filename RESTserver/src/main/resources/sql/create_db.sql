...
CREATE INDEX `categoryID_fk_idx` ON `product` (`category_id` ASC);
...
CREATE TABLE IF NOT EXISTS `history` (
  ...
  PRIMARY KEY (`user_id`, `product_id`, `used_date`),
...
CREATE INDEX `productid_fk_idx` ON `shopping_list` (`product_id` ASC);
